...
data class AideoPaddingValues(
    ...
    operator fun plus(other: PaddingValues): AideoPaddingValues = AideoPaddingValues(
    ...
    companion object {
        fun fromPaddingValues(paddingValues: PaddingValues): AideoPaddingValues = AideoPaddingValues(
            top = paddingValues.calculateTopPadding(),
            start = paddingValues.calculateStartPadding(LayoutDirection.Ltr),
            end = paddingValues.calculateEndPadding(LayoutDirection.Ltr),
            bottom = paddingValues.calculateBottomPadding(),
